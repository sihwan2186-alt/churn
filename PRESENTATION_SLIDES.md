...
| recall-heavy 확장 | XGBoost_SMOTE | 0.1253 | 0.9266 | 0.0672 | 101 | 1,402 | 8 |
...
| XGBoost recall-heavy | 1,503 | 101 | 1,402 | 159,000 | 2.14x |
...
> 본 프로젝트는 논문 baseline을 재현한 뒤, ZIP ablation, feature group ablation, segment error analysis, interpretability, 비용-편익 분석을 추가하여 불균형 churn 데이터에서 모델을 목적별로 선택하는 운영 프레임워크를 제시했다.

## Slide 12. Top-k 캠페인 예산 전략
...
## Slide 13. 비용 시나리오별 Threshold 민감도
...
## Slide 14. Calibration: 점수는 확률이 아니다
...
## Slide 16. 모델 합의도 기반 Risk Tiering
...
6. Slide 10-11: 한계와 1차 결론
7. Slide 12-16: 추가 케이스 스터디로 1시간 발표 확장
