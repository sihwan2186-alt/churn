...
| XGBoost_with_zip | XGBoost_SMOTE | 0.16 | 0.1242 | 0.9266 | 0.0665 | 101 | 1,417 | 8 | 157,200 |

발표 포인트:

- F1 기준이면 LR이 가장 좋다.
- 순이익 기준이면 recall-heavy 모델이 유리해진다.
- XGBoost는 recall 92.7%로 가장 많은 이탈 고객을 잡지만 FP도 1,417명으로 매우 많다.
...
| XGBoost_with_zip | 0.01 | 164,760 | 109 | 1,570 | 0 | 1.0000 | 0.0649 |
