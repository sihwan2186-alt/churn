...
| XGBoost recall-heavy | 101 | 1,417 | 8 | 1,518 | 92.7% | 157,200 | 2.12x | 1.93x | 0.92x |
...
| 확장 모델 포함 | XGBoost까지 포함 | XGBoost recall-heavy | 1,518 | 157,200 | 2.12x |
...
| XGBoost recall-heavy | 101 | 1,417 | 2,727 | +1,310 | 157,200 |
